...
public class BrowserDriver {
    ...
    public static AndroidDriver getBrowserDriver()  {
        ...
        if (appiumDriver == null) {
         ...
         //   caps.setCapability("chromedriverExecutable","dosya yolu"); eğer cep telefonunda chrome acilmazsa yapilir.
            // burada onemli olan cep telefonunun chrome versiyonu ile aynı olan degeri indirip caps e dosya olarak eklenmelidir.
